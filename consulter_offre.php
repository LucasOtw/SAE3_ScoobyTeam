...
<body>
    <header>
        <div class="logo">
            <img src="logoBlanc.png" alt="PAVCT Logo">
        </div>
        <nav>
            <ul>
    ...
    <main>
        <section class="profile">
            <div class="banner">
                <img src="Fond.png" alt="Bannière de profil">
            </div>
            <div class="profile-info">
                <img class="profile-picture" src="PhotodeProfil.png" alt="Profil utilisateur">
                <h1>Ti Al Lannec</h1>
        ...
        <section class="offers">
            ...
            <div class="add-new-offer">
                <button>Publier une nouvelle annonce</button>
            </div>
        </section>
    </main>
