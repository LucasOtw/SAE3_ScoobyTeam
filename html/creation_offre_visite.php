...
<head>
    ...
    <script>
        function toggleInput(checkbox) {
            var textInput = document.getElementById("autreText");
            if (checkbox.checked) {
    ...
    <main class="main-creation-offre2">
        ...
        <div class="form-container2">
            ...
            <form action="" method="post" enctype="multipart/form-data" onsubmit="checkFermeture()">
                ...
                <!-- Visite guidee -->
                <div class="visite-guidee">
                    <label>Langues proposé lors de la visite guidée</label>
                    <div class="checkbox-group">
                        <div>
                            <input type="checkbox" id="pas_visite_guidee" name="visite_guidee[]" value="">
                            <label class="label-check" for="pas_visite_guidee">Pas de visite guidée</label>
                        </div>

                        <div>
                            <input type="checkbox" id="francais" name="visite_guidee[]" value="français">
                            <label class="label-check" for="francais">En Français</label>
                        </div>

                        <div>
                            <input type="checkbox" id="anglais" name="visite_guidee[]" value="anglais">
                            <label class="label-check" for="anglais">En Anglais</label>
                        </div>

                        <div>
                            <input type="checkbox" id="espagnol" name="visite_guidee[]" value="espagnol">
                            <label class="label-check" for="espagnol">En Espagnol</label>
                        </div>

                        <div>
                            <input type="checkbox" id="chinois" name="visite_guidee[]" value="chinois">
                            <label class="label-check" for="chinois">En Chinois</label>
                        </div>

                        <div>
                            <label class="label-check">
                                <input type="checkbox" id="autreCheckbox" onclick="toggleInput(this)">
                                Autres langues
                            </label>
                            <br>
                            <input type="text" id="autreText" name="visite_guidee[]" placeholder="Entrer les autres langues">
                        </div>
            ...
            <?php
                ...
                $insert = $dbh ->prepare("insert into tripenarvor.offre_visite (titre_offre, date_publication, date_derniere_modif, _resume, _description, site_web, tarif, accessibilite, en_ligne, nb_blacklister, adresse_postale, complement_adresse, code_postal, ville, type_offre, duree, visite_guidee)
                                            values (:titre_offre, GETDATE(), GETDATE(), :resume, :description, :site_web, :tarif, :accessibilite, false, 0, :adresse_postale, :complement_adresse, :code_postal, :ville, :type_offre, :duree, :visite_guidee)");
                ...
                $insert->execute(["titre_offre" => $_POST["nom_offre"], 
                                    ...
                                    "duree" => $_POST["duree"],
                                    "visite_guidee" => implode(', ', $_POST["visite_guidee"])]);
