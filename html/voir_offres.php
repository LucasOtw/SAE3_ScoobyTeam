        ...
        try {
            ...
            foreach ($adresses as $adr) {
                ...
                if (isset($json['results'][0])) {
                    ...
                    $popupContent .= "<form action='detail_offre.php' method='POST' style='display:inline;'>
                    <input type='hidden' name='uneOffre' value='" . htmlspecialchars(serialize($offre)) . "'>
                    <input type='hidden' name='vueDetails' value='1'>
                    <button type='submit' style='display:inline-block; padding:6px 12px; background-color:#2DD7A4; 
                           color:white; text-decoration:none; border:none; border-radius:4px; 
