        ...
        try {
            ...
            foreach ($adresses as $adr) {
                ...
                if (isset($json['results'][0])) {
                    ...
                    $offre_encoded = urlencode(json_encode($offre));
                    $popupContent .= "<a href='detail_offre.php?uneOffre={$offre_encoded}&vueDetails=1' 
                                      style='display:inline-block; padding:6px 12px; background-color:#2DD7A4; 
                                      color:white; text-decoration:none; border-radius:4px; font-size:12px; 
                                      font-weight:500; transition:all 0.2s;'>Voir l'offre</a>";
