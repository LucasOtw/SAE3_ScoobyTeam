...
<!--<li><a href="historique_membre.php">Historique</a></li>-->
        ...
        <form id="form2FA" action="#" method="POST">
            ...
            <div class="connexion_membre_2fa">
                <button type="submit" id="enable2FABtn" class="btn-2fa" <?php if (!isset($isActivated2FA) && $isActivated2FA !== false) echo 'disabled'; ?>>Activer l’authentification à deux facteurs</button>
