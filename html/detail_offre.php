        ...
        <div class="avis">
            <div class="avis-content">
                <h3 class="avis">
                    ...
                    <a href="signalement.php?id_avis=<?php echo isset($avis['code_avis']) ? htmlspecialchars($avis['code_avis']) : 'invalide'; ?>" title="Signaler cet avis">
    🚩
</a>
...
"><?php echo $details_offre["titre_offre"]; ?></h1>
        ...
        <div class="avis-widget">
            <div class="avis-header">
                <h1 class="avis"><?php echo ($note_moyenne === null ? "Pas d'avis" : round($note_moyenne,1) . "/5") ?> <span class="avis-score"> <?php echo ($note_moyenne === null ? "" : $appreciationGenerale); ?></span></h1>
                <p class="avis"><?php echo $nombre_d_avis ; ?> avis<?php if ($nombre_d_avis > 1){ echo 's'; } ?></p>
            </div>
            <div class="avis-list">
                    <?php
                    foreach ($tout_les_avis as $avis) {
