    ...
    if($_SESSION['aCreeUneOffre'] === false){
        ...
        */
        ...
        if($creation_offre->execute($mon_offre)){
            ...
            $ajoutSpectacle = $dbh->prepare("INSERT INTO tripenarvor._offre_spectacle (code_offre,duree,capacite_accueil,date_spectacle,heure_spectacle)
...
<body>
    ...
    ?>
        <div class="fleche_retour">
            <div>
                <a href="../etape_3_boost/creation_offre_spectacle_3.php"><img src="../images/Bouton_retour.png" alt="retour"></a>
            </div>
        </div>
