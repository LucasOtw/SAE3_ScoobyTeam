...
<body>
    ...
    <div id="myModal" class="modal">
        <div class="modal-content">
            ...
            <img src="https://api.qrserver.com/v1/create-qr-code/?data=otpauth://totp/Monsite:example@example.com?secret=JBSWY3DPEHPK3PXP&issuer=MonSite&algorithm=SHA1&digits=6"
                alt="QR Code OTP">
