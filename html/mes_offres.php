...
<head>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=K2D:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,800&display=swap"
        rel="stylesheet">
</head>
    ...
    <main class="main_mes_offres">
        ...
        <section>
            ...
            <div class="button-container">
                ...
                <a href="mes_offres.php?filter=offline"
                    class="button-HorsLigne <?php echo $filter === 'offline' ? 'button-Active' : ''; ?>">Hors -
                    Ligne</a>
                <a href="mes_offres.php?filter=online"
                    class="button-Ligne <?php echo $filter === 'online' ? 'button-Active' : ''; ?>">En Ligne</a>
                <a href="mes_offres.php?filter=all"
                    class="button-toutes <?php echo $filter === 'all' ? 'button-Active' : ''; ?>">Toutes</a>
                ...
                <form action="detail_offre_pro.php" method="POST" class="offer-form">
                    ...
                    <div class="offer-card">
                        <div class="offer-image">
                            ...
                            <div
                                class="offer-status <?php echo $monOffre['en_ligne'] ? 'status-online' : 'status-offline'; ?>">
