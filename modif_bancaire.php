...
<header>
    ...
    <form action="#" method="POST">
        <h4>Modification des coordonées bancaires</h4>
        <div class="form-image-container">
            <div class="form-section">
                <div class="IBAN">
                    <fieldset>
                        <legend>IBAN</legend>
                        <input type="text" id="IBAN" name="IBAN" placeholder="FR1530003000506879851158R51" required> 
                    </fieldset>
                </div>
                <div class="BIC">
                    <fieldset>
                        <legend>BIC</legend>
                        <input type="text" id="BIC" name="BIC" placeholder="SOGEFRPP" required>
                    </fieldset>
                </div>
                <div class="nom-du-proprietaire">
                    <fieldset>
                        <legend>Nom</legend>
                        <input type="text" id="nom" name="nom" placeholder="MULLIEZ" required>
                    </fieldset>
                </div>
            </div>
